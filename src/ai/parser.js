...
- Removal scope on floor orders: a removal with NO floor mentioned applies to the product EVERYWHERE (all floors) - emit ONE removal item with floor=null. When the customer scopes the removal to a floor ("תורידו את המלפפונים מקומה 2"), set that floor on the removal item. Plural and singular product forms refer to the same product (מלפפונים = מלפפון).
