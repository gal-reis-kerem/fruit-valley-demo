...
contextBridge.exposeInMainWorld('api', {
  ...
  saveEmail: (creds) => ipcRenderer.invoke('save-email', creds),
  retryEmail: () => ipcRenderer.invoke('retry-email'),
  ...
  getStatsFull: (period) => ipcRenderer.invoke('get-stats-full', period),
  endDay: () => ipcRenderer.invoke('end-day'),
  resumeDay: () => ipcRenderer.invoke('resume-day'),
  getComplaints: () => ipcRenderer.invoke('get-complaints'),
  getRules: (workerId) => ipcRenderer.invoke('get-rules', workerId),
  workerChat: (worker, history) => ipcRenderer.invoke('worker-chat', worker, history),
